...
BEGIN
    ...
    INSERT INTO auth.users (
        ...
        -- Updated metadata to use first_name and last_name instead of full_name
    ...
    -- Updated to use first_name and last_name fields matching schema
...
BEGIN
    ...
    -- Updated all user metadata to use first_name and last_name
